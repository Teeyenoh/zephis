...
import uk.co.quarklike.zephis.map.item.Material;
import uk.co.quarklike.zephis.map.item.type.ItemType;
import uk.co.quarklike.zephis.map.item.type.ItemTypeDrink;
import uk.co.quarklike.zephis.map.item.type.ItemTypeFood;
