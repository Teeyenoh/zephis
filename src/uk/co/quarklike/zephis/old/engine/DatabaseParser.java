...
import uk.co.quarklike.zephis.old.map.entity.CharClass;
import uk.co.quarklike.zephis.old.map.entity.Race;
import uk.co.quarklike.zephis.old.map.item.Item;
import uk.co.quarklike.zephis.old.map.item.Material;
import uk.co.quarklike.zephis.old.map.item.type.ItemType;
import uk.co.quarklike.zephis.old.map.item.type.ItemTypeDrink;
import uk.co.quarklike.zephis.old.map.item.type.ItemTypeFood;
